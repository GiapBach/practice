...
//   console.log(`Entries processed. Inserted: ${insertedCount}, Skipped: ${skippedCount}`);
// }

// // Schedule fetchEntries to run every 60 seconds
// function startEntryFetchScheduler() {
//   connectDatabase();
//   fetchEntries(); // Initial run
//   setInterval(fetchEntries, 60 * 1000); // Run every 60 seconds
// }
...
// app.listen(PORT, () => {
//   console.log(`Server is running on port ${PORT}`);
//   startEntryFetchScheduler(); // Start the scheduler when the server starts
// });
